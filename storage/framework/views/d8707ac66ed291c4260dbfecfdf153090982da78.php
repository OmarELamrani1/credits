                        ...
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-controls="teams" aria-selected="false">
                                    ...
                                    <span class="ms-1"><?php echo e(__('Teams')); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab" aria-controls="dashboard" aria-selected="false">
                                    ...
                                    <span class="ms-1"><?php echo e(__('Projects')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/omar/Bureau/credits/resources/views/laravel-examples/user-profile.blade.php ENDPATH**/ ?>