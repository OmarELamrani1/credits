  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link <?php echo e((Request::is('user-management') ? 'active' : '')); ?>" href="<?php echo e(url('user-management')); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark <?php echo e((Request::is('user-management') ? 'text-white' : 'text-dark')); ?> " aria-hidden="true"></i>
            </div>
...
<?php /**PATH /home/omar/Bureau/credits/resources/views/layouts/navbars/auth/sidebar.blade.php ENDPATH**/ ?>